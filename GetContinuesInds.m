function [first_inds_of_continuum, second_ind_of_continuum] = GetContinuesInds(times, wav_inds)
...
for i = 1:length(inds_of_end_of_wavs)
    ...
    second_ind_of_continuum = [false; second_ind_of_continuum; diff(cur_wavfile_times)<0.3];
