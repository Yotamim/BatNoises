...
while ~move_to_next_wav
    ...
    uicontrol("Style","pushbutton","String", "delay", "Callback", @ReMarkDetection); 
    uicontrol("Style","pushbutton","String", "delay", "Callback", @TxRange); 
    uicontrol("Style","pushbutton","String", "delay", "Callback", @RxRange); 
...
%     first_button_pos = [1430         650         100          20];
